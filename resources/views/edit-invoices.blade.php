            ...
            <div class="row ml-220">
                <div class="col-lg-8 col-md-8 col-sm-4">
                    ...
                    <div class="bg-white py-4 px-4">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="input-group style-input" style="display:none;">
                                ...
                                <img id="logo-preview" src="{{ asset('images/'. $getInvoice->logo .'') }}" alt="Selected Logo" style="width: 120px; height: 120px;border-radius: 0%;">
                            </div>
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                                <input type="text" placeholder="{{$getInvoice->id}}" class="form-control" id="inovice_no" readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 pt-3">
                                <div class="d-flex align-items-center justify-content-end ">
                                    <label class="me-3" for="" style="font-weight: bold; font-size: 14px;">Issue
                                        date</label>
                                    <input class="form-control w-25" type="date" value="{{$getInvoice->invoice_date}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="d-flex align-items-center justify-content-end mt-3">
                                    <label class="me-3" for="" style="font-weight: bold; font-size: 14px;">Due
                                        date</label>
                                    <input class="form-control w-25" type="date" value="{{$getInvoice->due_date}}">
                                </div>
                            </div>
                        </div>
                        <div class="row pt-3">
                                ...
                                <div class="col-lg-6">
                                    <button type="button" class="btn modal-button text-start w-100 "
                                        ...
                                        <div class="d-flex mt-3 align-items-center">
                                            <div>
                                                <p id="sender_name" class="mb-0" style="font-size: 16px; color: #272b30;"></p>
                                                <span id="sender_contact_details" style="font-size: 18px; color: #272b30;">{{ $user->first_name }}</span><br>
                                                <span id="sender_contact_details" style="font-size: 16px; color: #6a7178;">{{ $user->email }}</span>
                                            </div>
                                        </div>
                                    </button>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <button type="button" class="btn modal-button text-start w-100"
                                    ...
                                    <div class="d-flex mt-3 align-items-center">
                                        <div>
                                            <p id="recipient_name" class="mb-0" style="font-size: 18px; color: #272b30;">{{ $clients->company_name }}</p>
                                            <p id="recipient_name" class="mb-0" style="font-size: 16px; color: #6a7178;">{{ $clients->email }}</p>
                                            <p id="recipient_name" class="mb-0" style="font-size: 16px; color: #6a7178;">{{ $clients->address }}</p>
                                            <p id="recipient_name" class="mb-0" style="font-size: 16px; color: #6a7178;">{{ $clients->phone_number }}</p>
                                            <p id="recipient_name" class="mb-0" style="font-size: 16px; color: #6a7178;">{{ $clients->company_reg_number }}</p>
                                            <p id="recipient_name" class="mb-0" style="font-size: 16px; color: #6a7178;">{{ $clients->vat_number }}</p>
                                            <p id="recipient_name" class="mb-0" style="font-size: 16px; color: #6a7178;">{{ $clients->attention_to }}</p>
                                            <p id="recipient_name" class="mb-0" style="font-size: 16px; color: #6a7178;">{{ $clients->contact_person }}</p>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mt-3">
                                <input type="text" placeholder="Enter company name" class="form-control py-2" id="add_company_info" value="{{$getInvoice->company_name}}">
                            </div>
                            <div class="col-lg-6 mt-3">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mt-3">
                                <input type="text" placeholder="Invoice description" class="form-control py-2" id="add_description" value="{{$getInvoice->invoice_description}}">
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row" >
                            <div class="col-lg-12">
                                <table class="table border" id="new_invoice_table" >
                                    ...
                                    @foreach($getInvoiceDetail as $detail)
                                    <tr>
                                        <td>{{ $detail->name }}</td>
                        ...
                        <div class="row span-style">
                            <div class="col-lg-12 pt-2">
                                <div class="float-end">
                                    ...
                                    <span class="ms-5 ps-5" id="invoice_subtotal">${{ $getInvoiceDetail->sum('subtotal') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="row span-style">
                            <div class="col-lg-12 pt-2">
                                <div class="float-end">
                                    ...
                                    <span class="ms-5 ps-5" id="invoice_tax" >${{ $getInvoiceDetail->sum('tax_rate') }}</span>
                        ...
                        <div class="row span-style">
                            <div class="col-lg-12 pt-2">
                                <div class="float-end">
                                    ...
                                    <span class="ms-5 ps-5" id="invoice_total" >${{ $getInvoiceDetail->sum('subtotal') }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <input type="text" class="form-control py-2" id="invoice_item"
                                       placeholder="Invoice items" value="{{ $getInvoice->line_item }}">
                            </div>
                        </div>
                        <div class="my-4">
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <input type="text" class="form-control py-2" id="invoice_item_description"
                                       placeholder="Invoice items description" value="{{ $getInvoice->line_item_description }}">
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 550px !important;" >
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height: 440px; overflow-y: auto;">
                    ...
                    <div class="row">
                                <div class="col-lg-12 pt-3 ">
                                    <div style="max-width: 540px;" class="card card-link" data-client="{{ json_encode($clients) }}">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <img src="{{ asset('images/'. $clients->logo .'') }}" class="card-img-top ms-3"
                                                     alt="..." style="width: 40px; height: 40px; border-radius: 50%; margin-top: 35px;">
                                            </div>
                                            <div class="col-md-7">
                                                <div class="card-body">
                                                    <h2 class="card-title">{{ $clients->company_name }}</h2>
                                                    <p class="m-0">{{ $clients->company_name }}</p>
                                                    <span>{{ $clients->email }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="mt-5 text-center">
                                                    <form id="deleteClient" action="{{ route('delete_client', $clients->id) }}" method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
